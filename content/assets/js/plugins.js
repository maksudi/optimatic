	...
	$.fn.prettyPhoto = function(pp_settings) {
		...
		*/
		$.prettyPhoto.open = function(event) {
			...
			social_tools = false; //Remove it to show up social tools 
...
/* prettyPhoto Version: 3.1.5 - prettyPhoto.js  End
-----------------------------------------------------------------------------*/
...
/* jquery.counterup.min.js 1.0  End
-----------------------------------------------------------------------------*/
